...
premierLeague = ["Arsenal" , "Aston Villa" ,"Brentford", "Brighton" , "Burnely" , "Chelsea", "Crystal Palace", "Everton", "Leeds" , "Leicester City" , "Liverpool" , "Manchester City" ,"Manchester United" , "Newcastle" , "Norwich", "Southampton" ,"Tottenham", "Watford" ,"West Ham","Wolves"]
